...
function countCard(){ //first fn on click
        ...
        if (turns.length===0){
              ...
              document.getElementById(turns[0]).innerHTML=repl1;
              ...
              if (document.getElementById(turns[0]).getAttribute('data-vals') == document.getElementById(turns[1]).getAttribute('data-vals')) 
              {
                    ...
                    document.getElementById(turns[0]).innerHTML=repl3;
                    var repl2= document.getElementById(turns[1]).getAttribute("data-vals");
                    document.getElementById(turns[1]).innerHTML=repl2;
                    ...
                    for (var k=0; k<16; k++) {
                        arrayOfTds.push(tdsUsed[k].innerHTML);
                        //alert(tdsUsed[k].innerHTML);
                    }
                    allTds=arrayOfTds.toString();
                    if ((allTds.split('N').length)<3){
                       var yourTime=document.getElementById("result").innerHTML;                     
                        alert("GAME OVER! Your time was " + yourTime);
                        location.reload();
                    }
                   //////////////////////////////////
                    ...
                    document.getElementById(turns[0]).innerHTML=repl7;
                    var repl8= document.getElementById(turns[1]).getAttribute("data-vals");
                    document.getElementById(turns[1]).innerHTML=repl8;
...
function flip() {
                ...
                document.getElementById(turns[0]).innerHTML="N";
                document.getElementById(turns[1]).style.color="purple";
                document.getElementById(turns[1]).innerHTML="N";
                turns=[];
}
};