...
putAnXBtn.onclick = function(){
 	...
 	// get a reference to the box
        ...
        var yPosition=Math.floor((Math.random() * (height-11)) + 1);  // should generate a value between 0 and the height
        var xPosition =Math.floor((Math.random() * (width-11)) + 1); //should generate a value between 0 and the width
